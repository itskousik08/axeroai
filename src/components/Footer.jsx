...
const Footer = () => {
  ...
  return (
    <footer className="bg-white border-t border-black/5 pt-16 pb-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-black/5 flex flex-col md:flex-row justify-between items-center text-gray-400">
